...
namespace BotService.Services
{
    public class CommandFactory
    {
        ...
        public void Initialize()
        {
            ...
            Add("/addplayertogame", ECommandType.AddPlayerToGame, EUserRole.Moderator, "Отменить игру");
            
            Add("/gameresult", ECommandType.GameResult, EUserRole.Moderator, "Внести результат игры");
            Add("/gamestatus", ECommandType.GameStatus, EUserRole.Moderator, "Получить статус игры");
